        ...
        <div className="py-8">
            <Container>
                <div className="w-full flex justify-center mb-4 relative border rounded-xl p-2">
                    <img
                        src={appwriteService.getFilePreview(post.featuredImage, 1200, 800)}
                        alt={post.title || post.tittle || ""}
                    ...
                    {userData && (
                        <div className="absolute left-6 top-6 bg-white/90 dark:bg-gray-900/90 px-3 py-2 rounded-lg text-sm">
                            Logged in as: {userData.email}
                        </div>
                    )}
                </div>
                <div className="w-full mb-6">
                    <h1 className="text-2xl font-bold">{post.title || post.tittle}</h1>
                </div>
